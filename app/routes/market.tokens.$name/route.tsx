...
export const loader: LoaderFunction = async ({ params }) => {
  ...
  const response: {
    collection: MarketPageTokenResponseType;
  ...
  if (collectionCache) {
    ...
    const [collectionOffersData, collectionOrdersData] =
    ...
    <div className="w-full space-y-6">
      ...
      <div className="flex items-center space-x-2 rounded-lg bg-red-700 p-2">
        ...
        <div className="text-sm text-white">
          Rune token collection only contains runes that meet the rules set by
          the project party.
        </div>
      </div>
      <Tabs
