...
const BulkBuyModal: React.FC<{
  ...
  const handleBuy = async () => {
    ...
    try {
      ...
      targets.push(...runePaymentOutput, ...itemOutput, {
      ...
      const opReturnCode = encodeOpReturn({
        edicts: sortedOffers.map((offer, index) => ({
          ...
          output: index + runePaymentOutput.length,
          amount: 0n,
        })),
      });
      ...
      onSuccess({
        ...
        runeNames: validOffers.map((offer) => offer.spacedName),
      });
